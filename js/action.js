...
//         _app.saveData('charts');
    ...
    collapse: function(override) {
      var isFull = typeof override === 'boolean' ? !override : document.body.classList.contains('full');
    ...
    toggleControls: function() {
      __.select('body').classList.toggle('hide-controls');
      _action.collapse(true);
    },
  };
